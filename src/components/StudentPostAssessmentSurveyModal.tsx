      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-xs animate-in fade-in duration-200">
        <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl border border-slate-100 flex flex-col max-h-[90vh]">
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-6 text-white text-center relative">
            ...
            <span className="inline-block rounded-full bg-white/25 px-3 py-0.5 text-xs font-semibold tracking-wide uppercase">
              Personalized Plan Ready
            </span>
            <h2 className="mt-2 text-xl font-bold tracking-tight sm:text-2xl">
              {generatedPlan.title}
            </h2>
            <p className="mt-1 text-xs text-blue-100 max-w-md mx-auto line-clamp-2">
