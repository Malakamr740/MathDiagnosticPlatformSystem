...
export const GlobalFloatingNavbar: React.FC = () => {
  ...
  const canGoBack = window.history.length > 1 && location.pathname !== '/admin' && location.pathname !== '/'
  ...
  return (
    <>
      ...
      >
        ...
        {/* Global Backward Navigation Bar within Sidebar */}
        <div className="p-2 border-b border-slate-100 bg-white">
          <div className="flex items-center gap-1.5">
            <button
              ...
              className={`flex-1 inline-flex items-center justify-center gap-1.5 py-1.5 px-2.5 rounded-xl border text-xs font-semibold transition ${
                canGoBack
                  ? 'border-slate-200 bg-white text-slate-700 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 shadow-2xs'
                  : 'border-slate-100 bg-slate-50 text-slate-400 cursor-not-allowed opacity-60'
              }`}
              disabled={!canGoBack}
            >
              <ChevronLeft className="h-3.5 w-3.5" />
              {isExpanded && <span>Backward</span>}
            </button>
            ...
            {isExpanded && (
              <Link
                ...
                className="inline-flex items-center justify-center p-1.5 rounded-xl border border-slate-200 bg-white text-slate-600 hover:text-blue-600 hover:bg-slate-50 transition"
              >
        ...
        >
          ...
          >
            ...
            <button
              ...
              disabled={!canGoBack}
              className={`inline-flex items-center gap-2 py-2 px-3 rounded-xl border text-xs font-semibold ${
                canGoBack
            ...
            >
              <ChevronLeft className="h-4 w-4" />
              <span>Backward to Previous Page</span>
            </button>
